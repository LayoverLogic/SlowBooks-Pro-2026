...
def create_company(db: Session, name: str, database_name: str, description: str = None) -> dict:
    ...
    try:
        ...
        # Quote the db name via the dialect identifier_preparer rather than an
        # f-string literal - defence-in-depth against SQL injection on top of the
        # regex guard above (CodeQL CWE-089 fix).
